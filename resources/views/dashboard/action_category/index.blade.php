...
@section("pagetitle", " Categories Actions")
...
<div class="col-xs-12">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title col-md-6">Categories Actions</h3>
	  	<div class="col-md-6">
  			      ...
  			      <div class="modal-body">
  							<div class="container-fluid">
  								<div class="row">
  						      	...
  						      	<form name="sentMessage" id="contactForm" action="{{route('action_categories.store')}}" method="POST" data-parsley-validate>
        ...
        <tbody>
          @foreach($categories as $category)
            <tr>
              ...
              <td class="fit"><a href="{{route('action_categories.show', $category->id)}}">{{ $category -> name }}</a></td>
              <td class="fit">{{$category->actions->count()}}</td>
              <td>{{ date('d M Y', strtotime($category -> created_at)) }}</td>
              <td>{{ date('d M Y', strtotime($category -> updated_at)) }}</td>

              <td>
                <a href="{{route('action_categories.show', $category->id)}}" class="btn btn-default"><span class="glyphicon glyphicon-eye-open"> </span> View</a>
              </td>
            </tr>
          @endforeach
        </tbody>
