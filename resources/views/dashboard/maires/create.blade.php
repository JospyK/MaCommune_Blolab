...
@section("pagetitle", " Maires - Creer")
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="login-panel panel panel-default" style="margin-top: 20px;">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{route('maires.store')}}" id="login-form" enctype="multipart/form-data">
                            <fieldset>
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="name" type="name" class="form-control" name="name" value="{{ old('name') }}" placeholder="Nom" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="discours" type="discours" class="form-control" name="discours" placeholder="Mot du Maire" rows="8" required></textarea>
                                    </div>
                                </div>
